                    ...
                    <div class="column">
                        <keep-alive>
                            <component
                                ...
                                ref="activeComponent"
                                :course="course"
                                @onCourseValueUpdate="handleCourseValueUpdate"
                            />
                        </keep-alive>
                    </div>
                </div>
...
export default {
    ...
    computed: {
        ...mapGetters({
            course: "instructor/course/getCourse",
            canUpdateCourse: "instructor/course/canUpdateCourse",
        }),
    },
    methods: {
        handleCourseValueUpdate({ value, field }) {
        ...
        onCourseUpdate() {
            this.$store
                ...
                .catch(() =>
                    this.$toasted.error(
                        "An error ocurred while updating course",
                        { duration: 2000 }
                    )
                );
        },
